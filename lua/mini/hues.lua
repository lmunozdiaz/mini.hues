...
H.apply_colorscheme = function(config)
  ...
  hi('Operator',       { link='Statement',      bg=nil })
  ...
  if vim.fn.has('nvim-0.8') == 1 then
    ...
    hi('@type',             { link='Type' })
    hi('@type.builtin',     { fg=p.red, bg=nil })
  ...
  if vim.fn.has('nvim-0.9') == 1 then
    ...
    hi('@keyword.import',    { fg=p.orange, bg=nil, bold=true })
  ...
  if has_integration('echasnovski/mini.nvim') then
    ...
    hi('MiniFilesCursorLine',     { fg=nil, bg=p.bg_mid2 })
    ...
    hi('MiniPickMatchCurrent',  { fg=nil, bg=p.bg_mid2 })
