...
H.apply_colorscheme = function(config)
  ...
  hi('CursorLine',     { fg=nil,       bg=p.bg_edge })
  ...
  hi('Operator',       { link='Delimiter',      bg=nil })
  hi('PreCondit',      { link='PreProc' })
  hi('PreProc',        { fg=p.blue,    bg=nil })
  hi('Repeat',         { link='Statement' })
  hi('Special',        { fg=p.red,    bg=nil })
  hi('SpecialChar',    { link='Special' })
  hi('SpecialComment', { link='Special' })
  hi('Statement',      { fg=p.purple,      bg=nil,         bold=true })
  ...
  if vim.fn.has('nvim-0.8') == 1 then
    ...
    hi('@parameter',        { link='Identifier', bg=nil })
  ...
  if vim.fn.has('nvim-0.9') == 1 then
    ...
    hi('@keyword.import',    { fg=p.azure, bg=nil, bold=true })
